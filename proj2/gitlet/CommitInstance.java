 ...
 *  @author dhzp
 */
public class CommitInstance implements Serializable {
    /** A mapping of origin file names to hash names. */
    private final TreeMap<String, String> blobs;
    /** The timestamp, date and time, of this CommitInstance. */
    ...
    public CommitInstance(CommitInstance parent,
    ...
    /** Creates a commit node. */
    public CommitInstance(CommitInstance parent, CommitInstance secParent,
                          String msg, TreeMap<String, String> blobs) throws IOException {
